...
Тема: Подготовка космонавтов.
Выполнил: Ефимова Ксения Алексеевна.

## НАЗНАЧЕНИЕ И ОБЛАСТЬ ПРИМЕНЕНИЯ

Главной целью программы является успеть выполнить все этапы подготовки космонавтов, для успешного покорения ими космоса.
...
В связи с выданной темой, было принято решение использовать классический подход для создания текстовых ролевых игр.

### Функции программы

Выбор идеально подходящих кандидатов для полета
Проведение тестирования кандидатов
Проведение тестирования игрока 
Выбор музыки для полета 
Выбор испытаний для тестирования кандидатов 
...
Работа в выполнена в графическом редакторе кода: Geany
Запуск программы выполняется в среде Instead

### Ожидаемые экономические показатели

Ожидается положительная оценка (рекомендуется поставить отлично) в зачетную книжку.
